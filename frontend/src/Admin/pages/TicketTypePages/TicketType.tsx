...
import {
  getTicketTypes,
  deleteTicketType,
} from "@/services/TicketTypeServices";
...
const TicketType = () => {
  ...
  const filteredTycketTypes = data.filter((event) =>
  ...
  const currentTicketType = filteredTycketTypes.slice(
    indexOfFirstItem,
    indexOfLastItem,
  );
  return (
                ...
                <tr key={event.ticketTypeId} className="hover:bg-gray-50">
                  ...
                  <td className="flex items-center justify-center gap-[6px] px-[10px] py-[10px] whitespace-nowrap">
                    <Button
                      ...
                      variant="ghost"
                      onClick={() =>
                        navigate(`/admin/ticket-type/${event.ticketTypeCode}`)
                      }
                    >
                      <img
                        src="/icons/Eye.svg"
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/admin/ticket-type/${event.ticketTypeCode}/edit`,
                        )
                      }
                    >
                      <img
