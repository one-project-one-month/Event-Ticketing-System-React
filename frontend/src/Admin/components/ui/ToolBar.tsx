...
const Toolbar: FC<ToolbarProps> = ({ onSearch, onExport, addNewPath }) => {
  ...
  return (
    <div className="flex w-full items-center justify-between gap-4 px-2 pt-4">
      <div className="relative w-1/2 max-w-[480px]">
        ...
        <Input
          ...
          placeholder="Search"
          className="h-[56px] w-full rounded-[16px] border-none bg-[#EEF0FA] pl-12 text-base font-medium text-[#6B6B6B] shadow-none placeholder:text-[#6B6B6B] dark:placeholder:text-white"
        />
      </div>
