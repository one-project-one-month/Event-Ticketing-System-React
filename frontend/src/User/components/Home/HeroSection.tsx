...
export default function HeroSection() {
  return (
    <main className="absolute top-0 left-0 h-screen w-screen [&>*]:text-white">
      {/* Background Image */}
      <div className="absolute top-0 left-0 z-0 h-[50rem] w-full">
        <img
      ...
      {/* Hero Elements */}
      <div className="absolute top-52 left-0 z-20 grid w-full grid-cols-8 px-15">
        {/* Big Text */}
        <div className="col-span-5 mt-1 ml-5 flex flex-col justify-start gap-0 [&>p]:text-8xl [&>p]:font-semibold">
          <p>GET READY TO EXPERIENCE THE BEST EVENTS</p>
        </div>
        {/* Image */}
        <div className="col-span-3 row-span-3 ml-6 h-[39.5rem] w-[29rem] overflow-hidden rounded-t-full rounded-b-lg shadow-lg shadow-gray-800">
          <img
            src={HeroImg}
            alt="Hero Image"
        ...
        {/* Small Text */}
        <div className="col-span-5 mt-14 mr-20 flex flex-row items-center justify-center">
